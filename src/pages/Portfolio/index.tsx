...
export const Portfolio: React.FC<IPortfolio> = ({
  ...
  const { setIsDeleteOrPlus, setDeletedObj, getPortfolioPrice } =
    useTotalCostContext();
        ...
        {holdings.length === 0 ? (
          <div className={styles.empty}>
            ...
            <p className={styles.emptyText}>
              Add a coin from the markets table with the “+” button to start
              tracking it here.
            </p>
          </div>
        ) : (
                  ...
                  <tr key={obj.name}>
                    ...
                    <td>
                      ...
                      >
                        ...
                        >
                          <path
                            d="M4 7H20M9 7V5C9 4.44772 9.44772 4 10 4H14C14.5523 4 15 4.44772 15 5V7M18 7L17.3 18.5C17.2 19.9 16.1 21 14.7 21H9.3C7.9 21 6.8 19.9 6.7 18.5L6 7"
                            stroke="currentColor"
                            strokeWidth="1.6"
                            strokeLinecap="round"
